...
| [**FPGA AI Accelerator**](https://github.com/SensiNerveX_FPGA) | Seeing how much AI fits into programmable logic before timing reports start crying. | `Verilog` `FPGA` `AI` |
